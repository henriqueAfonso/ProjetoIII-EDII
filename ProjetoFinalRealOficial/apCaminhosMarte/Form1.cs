...
namespace apCaminhosMarte
{
    public partial class Form1 : Form
    {
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione corretamente um método de busca e um critério");
                return;
            }
                ...
                case "Pilhas":
                    {
                        switch(criterio)
                        {
                            ...
                            case "Distância": solucionador.SolucionaBacktracking(origem.CodCidade, destino.CodCidade, "distancia"); break;
                        }
                    } break;
                case "Recursão": 
                    {
                        switch (criterio)
                        {
                            ...
                            case "Distância": solucionador.SolucionaRecursivo(origem.CodCidade, destino.CodCidade, "distancia"); break;
                        }
                    } break;
                case "Dijkstra": 
                    {
                        switch (criterio)
                        {
                            case "Custo":     solucionador.SolucionaDjikstra(origem.CodCidade, destino.CodCidade ,3); break;
                            case "Tempo":     solucionador.SolucionaDjikstra(origem.CodCidade, destino.CodCidade, 2); break;
                            case "Distância": solucionador.SolucionaDjikstra(origem.CodCidade, destino.CodCidade, 1); break;
                        }
                    } break;
            }
